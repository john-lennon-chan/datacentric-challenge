...
if __name__ == "__main__":
    ...
    import json
    split = read_split(r"/Users/lennonchan/Documents/splits_final.json", 0)
    prediction_folder = r"/Users/lennonchan/Documents/predicted_images"
    ground_truth_folder = r"/Users/lennonchan/Documents/labelsTr"
    organ_segmentation_folder = r"/Users/lennonchan/Documents/SegResNet"
    metrics_folder = r"/Users/lennonchan/Documents/metrics_per_organ"

    organ_list_path = r"/Users/lennonchan/Documents/totalsegmentator_organ_list.json"
    ...
    for train_or_val in ["val"]:
        for file in tqdm(list(reversed([file for file in split[train_or_val] if file not in processed_files])), desc=f"Processing {train_or_val} data"):
